...
module.exports.init = function(callback) {
    ...
    redis.on('websockets', 'grading_job_status_updated', module.exports._handleGradingJobStatusUpdated);
...
module.exports._handleGradingJobStatusUpdated = function(data) {
    const { grading_job_id } = data;
...
module.exports.gradingJobStatusUpdated = function(grading_job_id) {
    redis.emit('websockets', 'grading_job_status_updated', { grading_job_id });
};
